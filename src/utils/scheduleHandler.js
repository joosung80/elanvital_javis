...
- "9시", "10시", "11시" = 오전 시간으로 해석 (09:00, 10:00, 11:00)
- "오전 6시", "AM 6시" = 06:00
- "오후 6시", "PM 6시" = 18:00
...
**종일 일정 판단 규칙:**
다음 경우에만 종일 일정으로 처리:
1. "종일", "하루종일", "전일", "올데이", "all day" 키워드가 명시적으로 포함된 경우
2. 날짜만 언급되고 시간 관련 단어가 전혀 없는 경우 (예: "내일 회의", "오늘 휴가")

**시간 지정 일정 판단 (우선 처리):**
다음 중 하나라도 포함되면 시간 지정 일정으로 처리:
- 시간 단위: "시", "분", "초" (예: "시", "3시", "30분", "1시간")
- 시간 표현: "오전", "오후", "새벽", "밤", "AM", "PM"
- 구체적 시간: "10:30", "14:00", "9:15"
- 지속시간: "부터", "까지", "동안", "간" (예: "3시부터", "1시간동안")

**중요**: "시"라는 단어가 포함되면 반드시 시간 지정 일정으로 처리해야 함
...
- "9월16일 3시 메일정리" → 시작: 9월16일 15:00, 종료: 9월16일 16:00
